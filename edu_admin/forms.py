...
from edu_admin.models import Course
...
class AddCourseForm(forms.ModelForm):
    ...
    course_id = forms.CharField(label="course_id", widget=forms.TextInput(attrs={'placeholder': u'请输入课程编号', "class": "form-control", "id": "id", "style": "width: 200px"}))
    ...
    class Meta:
        model = Course
        fields = ("course_name", "course_id", "time", "place_id", "teacher_id", "course_num", "course_belong", "course_char", "credit")
