...
urlpatterns = [
    ...
    path("Stu_change_passwd.html/", views.Stu_chage_passwd, name="Stu_chage_passwd"),
    path("Tea_change_passwd.html/", views.Tea_chage_passwd, name="Tea_chage_passwd"),
    path("Adm_change_passwd.html/", views.Adm_change_password, name="Adm_change_password"),
